...
<head>
    ...
    <title>Nuevo Rubro Presupuestal</title>
...
<div class="container py-4">
    <h1 class="mb-4">Nuevo rubro presupuestal</h1>
    <form action="{{route('bincome.store')}}" method="post">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" name="categoria" id="categoria" placeholder="Categoria de ingreso">
            </div>
        </div>
